  ...
  class CppMode < Mode
    def initialize
      ...
      @style = [
        ...
        :color_default, # SCE_C_GLOBALCLASS 19
        :color_string, # SCE_C_STRINGRAW 20
        :color_default, # SCE_C_TRIPLEVERBATIM 21
        ...
        :color_default, # SCE_C_USERLITERAL 25
        :color_default, # SCE_C_TASKMARKER 26
