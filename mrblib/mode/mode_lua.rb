module Mrbmacs
  class LuaMode < Mode
    def initialize
      ...
      @start_of_comment = '# '
      @style = [
        :color_default, # define SCE_LUA_DEFAULT 0
